        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="events.php">Event Add</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="show_all_events.php">Show ALL Events</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="reg_team.php">All registered Team</a>
                    </li>
                    <!-- <li class="nav-item">
