...
<body>
    ...
    $sql  = "SELECT * FROM match_events ORDER BY date ASC";
            ...
            <tr>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '
                        ...
                        <td>' . $vanue . '</td>
                        <td>
                        <button type="button" class="btn btn-primary"><a href="update_events.php?updateid=' . $id1 . '" class="text-light">Update</a></button>
                        <button type="button" class="btn btn-danger"><a href="delete_event.php?deleteid=' . $id1 . '" class="text-light">Delete</a></button>
                    </td>
                    ';
                ?>
            </tr>
